  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved land as @land" do
        ...
        post :create, {:land => { "name" => "invalid value" }}, valid_session
        assigns(:land).should be_a_new(Land)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested land" do
        ...
        Land.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => land.to_param, :land => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the land as @land" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Land.any_instance.stub(:save).and_return(false)
        put :update, {:id => land.to_param, :land => { "name" => "invalid value" }}, valid_session
        assigns(:land).should eq(land)
      end
