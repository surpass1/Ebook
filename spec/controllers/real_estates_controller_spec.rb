...
describe RealEstatesController do
  ...
  describe "GET show" do
    it "assigns the requested real_estate as @real_estate" do
      real_estate = RealEstate.create! valid_attributes
      get :show, {:id => real_estate.to_param}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested real_estate as @real_estate" do
      real_estate = RealEstate.create! valid_attributes
      get :edit, {:id => real_estate.to_param}, valid_session
      assigns(:real_estate).should eq(real_estate)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new RealEstate" do
        expect {
          post :create, {:real_estate => valid_attributes}, valid_session
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved real_estate as @real_estate" do
        ...
        post :create, {:real_estate => { "name" => "invalid value" }}, valid_session
        assigns(:real_estate).should be_a_new(RealEstate)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested real_estate" do
        ...
        RealEstate.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => real_estate.to_param, :real_estate => { "name" => "MyString" }}, valid_session
      end

      it "assigns the requested real_estate as @real_estate" do
        real_estate = RealEstate.create! valid_attributes
        put :update, {:id => real_estate.to_param, :real_estate => valid_attributes}, valid_session
        assigns(:real_estate).should eq(real_estate)
      end
    ...
    describe "with invalid params" do
      it "assigns the real_estate as @real_estate" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        RealEstate.any_instance.stub(:save).and_return(false)
        put :update, {:id => real_estate.to_param, :real_estate => { "name" => "invalid value" }}, valid_session
        assigns(:real_estate).should eq(real_estate)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested real_estate" do
      real_estate = RealEstate.create! valid_attributes
      expect {
        delete :destroy, {:id => real_estate.to_param}, valid_session
      }.to change(RealEstate, :count).by(-1)
    end
